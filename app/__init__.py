...
WHY THIS FILE EXISTS:
    The app factory pattern lets us create multiple instances of the app
    with different configurations (dev, test, production). This is the
    industry-standard approach for Flask applications.
"""
